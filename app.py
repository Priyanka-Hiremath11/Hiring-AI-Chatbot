...
# ---------------- QUESTIONS ----------------
st.write("Hello! I'm your AI Hiring Assistant. I'll ask you a few questions to understand your background and skills, then generate some technical questions based on your input. Let's get started! 🚀")
questions = [
